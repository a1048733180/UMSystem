...
//        // 返回学生顺序表，方便分页查询
//        String statement = "com.luo.dao.StudentDao.getStudentList";
//        studentList = MyBatisUtil.getSqlSession().selectList(statement);
//        return this.studentList;
//    }
////
////    // 把学生排序表更新到本地
...
//        String statement = "com.luo.dao.StudentDao.selectStudentById";
//        Student student = MyBatisUtil.getSqlSession().selectOne(statement, id);
//        return student;
//    }
//
//    @Override
//    public void alertStudent(Student student) {
//        String statement = "com.luo.dao.StudentDao.alertStudent";
//
//    }
//
//}
