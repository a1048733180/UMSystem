        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'teacherId', title: 'ID', width: 50, sortable: true},
                    {field: 'teacherName', title: '姓名', width: 150},
                    {field: 'teacherSex', title: '性别', width: 100},
                    {field: 'entryYear', title: '入职年份', width: 150},
                    {field: 'teacherTel', title: '联系方式', width: 200},
                        ...
                        formatter: function (value, row, index) {
                            if (row.courseList) {
                                ...
                                for (var i = 0; i < courseList.length; i++) {
                                    var professionName = courseList[i].profession.professionName;
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            if (!validate) {
                                ...
                                var id = $("#add_teacherId").textbox("getText");
                                var name = $("#add_teacherName").textbox("getText");
                                var sex = $("#add_teacherSex").textbox("getText");
                                var entryYear = $("#add_entryYear").textbox("getText");
                                var tel = $("#add_teacherTel").textbox("getText");
                                ...
                                $.ajax({
                                    ...
                                    success: function (msg) {
                                        if (msg == "success") {
                                            ...
                                            $("#add_teacherSex").textbox('setValue', "男");
                                            $("#add_entryYear").textbox('setValue', "");
                                            $("#add_teacherTel").textbox('setValue', "");
                                            ...
                                            $.messager.alert("消息提醒", "添加失败,课程已存在！", "warning");
                                            return;
                                        } else {
            ...
            $("#add_courseList").combobox({
                ...
                onLoadSuccess: function () {
                    //默认选择第一条数据
                    var data = $(this).combobox("getData");
                    $(this).combobox("setValue", data[0].courseId);
                }
            });
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            if (!validate) {
                                ...
                                var id = $("#edit_teacherId").textbox("getText");
                                var name = $("#edit_teacherName").textbox("getText");
                                var sex = $("#edit_teacherSex").textbox("getText");
                                var entryYear = $("#edit_entryYear").textbox("getText");
                                var tel = $("#edit_teacherTel").textbox("getText");
                                ...
                                $.ajax({
                                    ...
                                    success: function (msg) {
                                        if (msg == "success") {
                                            ...
                                            $("#edit_teacherTel").textbox('setValue', "");
    ...
    <form id="addForm" method="post">
        <table id="addTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6">
            <tr>
                ...
                <td colspan="3">
                    <input id="add_teacherId" class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="id"
            ...
            <tr>
                <td>姓名:</td>
                <td colspan="4"><input id="add_teacherName" style="width: 200px; height: 30px;" class="easyui-textbox"
                                       type="text" name="name" data-options="required:true, missingMessage:'请填写姓名'"/>
                </td>
            </tr>
            <tr>
                <td>性别:</td>
                <td colspan="4"><select id="add_teacherSex" class="easyui-combobox"
            ...
            <tr>
                <td>入职年份:</td>
                <td colspan="4"><input id="add_entryYear" style="width: 200px; height: 30px;" class="easyui-textbox"
                                       type="text" name="entryYear"/></td>
            </tr>
            <tr>
                <td>职称:</td>
                <td colspan="4"><select id="add_jobTitle" class="easyui-combobox"
            ...
            <tr>
                <td>联系方式：</td>
                <td colspan="4"><input id="add_teacherTel" style="width: 200px; height: 30px;" class="easyui-textbox"
                                       type="text" name="teacherTel"/></td>
            </tr>
        </table>
    </form>
</div>
...
<div id="chooseCourseDialog" style="padding: 10px">
    <table cellpadding="8">
        <tr>
            <td>专业：</td>
            <td><input id="add_professionList" style="width: 200px; height: 30px;" class="easyui-combobox"
                       name="professionid"/></td>
        </tr>
        <tr>
            <td>课程：</td>
...
<div id="editDialog" style="padding: 10px">
    <form id="editForm" method="post">
        <table id="editTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6">
            <tr>
                <td style="width:40px">ID:</td>
                <td colspan="3"><input id="edit_teacherId" data-options="readonly: true" class="easyui-textbox"
                                       style="width: 200px; height: 30px;" type="text" name="id"
                                       data-options="required:true, validType:'repeat', missingMessage:'请输入工号'"/></td>
                <td style="width:80px"></td>
            </tr>
            <tr>
                <td>姓名:</td>
                <td><input id="edit_teacherName" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="name" data-options="required:true, missingMessage:'请填写姓名'"/></td>
            </tr>
            <tr>
                <td>性别:</td>
                <td><select id="edit_teacherSex" class="easyui-combobox"
            ...
            <tr>
                <td>入职年份:</td>
                <td><input id="edit_entryYear" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="entryYear"/></td>
            </tr>
            <tr>
                <td>联系方式:</td>
                <td><input id="edit_teacherTel" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="teacherTel"/></td>
            </tr>
            <tr>
                <td>职称:</td>
                <td colspan="4"><select id="edit_jobTitle" class="easyui-combobox" data-options="editable: false, panelHeight: 100, width: 80, height: 30" name="jobTitle">
                <option value="副教授">副教授</option>
                <option value="教授">教授</option>
                <option value="讲师">讲师</option>
                <option value="助教">助教</option>
