    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"2","icon":"","menuname":"教师信息管理",
							"menus":[
									{"menuid":"21","menuname":"教师列表","icon":"icon-user-teacher","url":"TeacherServlet?method=toTeacherListView"},
								]
						},
						{"menuid":"3","icon":"","menuname":"基础信息管理",
							"menus":[
									{"menuid":"31","menuname":"专业列表","icon":"icon-world","url":"ProfessionServlet?method=toProfessionListView"},
									{"menuid":"32","menuname":"课程列表","icon":"icon-book-open","url":"CourseServlet?method=toCourseListView"}
								]
						},
